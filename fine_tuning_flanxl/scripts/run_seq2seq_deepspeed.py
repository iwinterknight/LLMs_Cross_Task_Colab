...
def parse_arge():
    ...
    parser.add_argument("--checkpoint_dir", type=str, default=None, help="Checkpoint directory to store model checkpoint files.")
...
def training_function(args):
    ...
    if args.checkpoint_dir:
        ...
        print("###################################################### Loaded model from checkpoint {} ######################################################".format(args.checkpoint_dir))
    else:
        model = AutoModelForSeq2SeqLM.from_pretrained(
            args.model_id,
            use_cache=False if args.gradient_checkpointing else True,  # this is needed for gradient checkpointing
